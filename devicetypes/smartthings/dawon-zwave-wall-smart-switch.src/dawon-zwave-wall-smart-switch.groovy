 ...
 */
metadata {
	definition (name: "Dawon Z-Wave Wall Smart Switch (modified)", namespace: "smartthings", author: "SmartThings", mnmn:"SmartThings", vid:"generic-humidity-3" , ocfDeviceType: "oic.d.thermostat") {
